...
const experience = [
    { 
      ...
      gallery: ["/robotik3.jpg", "/robotik2.jpg", "/robotik1.jpg", "/robotik5.jpg", "/robotik6.jpg", "/robotik7.jpg", "/robotik8.jpg", "/robotik9.jpg", "/robotik10.jpg", "/robotik11.jpg", "/robotik12.jpg", "/robotik13.jpg" ] 
    },
    { 
    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; border-left: none !important; border-right: none !important; }
        ...
        /* MODIFIKASI HERO UNTUK VIDEO */
        .hero {
          position: relative;
          width: 100%; height: 100vh;
          display: flex; flex-direction: column; justify-content: center;
          align-items: center; text-align: center; padding: 0 5%;
          overflow: hidden; /* Biar video nggak melebar keluar batas */
        }
        ...
        .hero-content {
          position: relative;
          z-index: 2; /* Biar tulisan ada di depan video */
        }
...
/* Biar gerakannya nggak barengan, kita bedain delay-nya */
      ...
      <div className="ultra-full-layout">
        ...
        <section id="about" className="hero reveal">
          ...
          <div className="video-container">
            <video ref={videoRef} autoPlay muted loop playsInline style={{ opacity: isDark ? 0.4 : 0.7 }}>
          ...
          <div className="hero-content">
            ...
            <p className="fade-in" style={{ letterSpacing: '5px', color: theme.accent, fontWeight: 'bold', fontSize: '0.9rem', margin: '0 auto 20px auto', animationDelay: '0.6s' }}>
              CYBER SECURITY | INTERNET OF THINGS | FULLSTACK DEV
            </p>
            <p className="fade-in" style={{ maxWidth: '800px', fontSize: '1.2rem', color: isDark ? '#ccc' : '#444', lineHeight: '1.8', margin: '0 auto', animationDelay: '0.8s' }}>
...
<div style={{ minWidth: 0 }}>
  ...
  <div className="fade-in" style={{ 
    ...
    {/* Kita looping ikonnya supaya masing-masing dapet kelas animasi */}
    {['kali','linux','vscode','react','html','css','js','php','mysql','python','cpp','flutter','figma','photoshop','illustrator','premiere','aftereffects'].map((icon, index) => (
      <img 
        key={index}
        src={`https://skillicons.dev/icons?i=${icon}`} 
        alt={icon}
        className={`floating-icon delay-${(index % 4) + 1}`} // Pake delay 1-4 secara bergantian
        style={{ 
          width: '50px', // Ukuran ikon diperkecil dikit biar rapi
          height: '50px',
          display: 'block'
        }} 
      />
